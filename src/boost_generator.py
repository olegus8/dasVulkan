...
class BoostGenerator(LoggingObject):
    ...
    def __init__(self, context):
        ...
        self.macro_consts = dict((x.name, x)
            for x in self.__context.macro_consts)
    ...
    @property
    def title(self):
        gv = self.__glfw_version
        vv = self.__vk_version
        return f'// generated by dasVulkan for GLFW {gv} and Vulkan {vv}'

    @property
    def __glfw_version(self):
        return '.'.join(self.macro_consts[name].value for name in [
            'GLFW_VERSION_MAJOR',
            'GLFW_VERSION_MINOR',
    ...
    def __link_vk_function(self, func):
        ...
        return [
            f'',
            f'g_vk_linked_{fn} = (PFN_{fn}) vkGetInstanceProcAddr('
                f'instance, "{fn}");',
