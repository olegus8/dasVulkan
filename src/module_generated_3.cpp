...
void addVulkanGenerated_3(Module & module, ModuleLibrary & lib) {{
    ...
    module.addAnnotation(make_smart<VkImageBlitAnnotation>(lib));
    module.addAnnotation(make_smart<VkImageCopyAnnotation>(lib));
    module.addAnnotation(make_smart<VkImageResolveAnnotation>(lib));
    module.addAnnotation(make_smart<VkRenderPassBeginInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceSubgroupPropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkBindBufferMemoryInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkBindImageMemoryInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDevice16BitStorageFeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkMemoryDedicatedRequirementsAnnotation>(lib));
    module.addAnnotation(make_smart<VkMemoryDedicatedAllocateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkMemoryAllocateFlagsInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceGroupRenderPassBeginInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceGroupCommandBufferBeginInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceGroupSubmitInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceGroupBindSparseInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkBindBufferMemoryDeviceGroupInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkBindImageMemoryDeviceGroupInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceGroupPropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceGroupDeviceCreateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkBufferMemoryRequirementsInfo2Annotation>(lib));
    module.addAnnotation(make_smart<VkImageMemoryRequirementsInfo2Annotation>(lib));
    module.addAnnotation(make_smart<VkImageSparseMemoryRequirementsInfo2Annotation>(lib));
    module.addAnnotation(make_smart<VkMemoryRequirements2Annotation>(lib));
    module.addAnnotation(make_smart<VkSparseImageMemoryRequirements2Annotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceFeatures2Annotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceProperties2Annotation>(lib));
    module.addAnnotation(make_smart<VkFormatProperties2Annotation>(lib));
    module.addAnnotation(make_smart<VkImageFormatProperties2Annotation>(lib));
