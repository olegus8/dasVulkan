...
void addVulkanGenerated_15(Module & module, ModuleLibrary & lib) {
    ...
    module.addAnnotation(make_smart<VkPhysicalDevice4444FormatsFeaturesEXTAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceOrHostAddressKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkDeviceOrHostAddressConstKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureBuildRangeInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureGeometryTrianglesDataKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureGeometryAabbsDataKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureGeometryInstancesDataKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureGeometryDataKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureGeometryKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureBuildGeometryInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureCreateInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkWriteDescriptorSetAccelerationStructureKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceAccelerationStructureFeaturesKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceAccelerationStructurePropertiesKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureDeviceAddressInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureVersionInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkCopyAccelerationStructureToMemoryInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkCopyMemoryToAccelerationStructureInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkCopyAccelerationStructureInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkAccelerationStructureBuildSizesInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkRayTracingShaderGroupCreateInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkRayTracingPipelineInterfaceCreateInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkRayTracingPipelineCreateInfoKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceRayTracingPipelineFeaturesKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceRayTracingPipelinePropertiesKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkStridedDeviceAddressRegionKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkTraceRaysIndirectCommandKHRAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceRayQueryFeaturesKHRAnnotation>(lib));
    module.addAnnotation(make_smart<GLFWvidmodeAnnotation>(lib));
