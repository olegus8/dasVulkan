...
void addVulkanGeneratedEnums_5(Module & module, ModuleLibrary & lib) {
...
void addVulkanGeneratedOpaqueStructs_5(Module & module, ModuleLibrary & lib) {
...
void addVulkanGeneratedStructs_5(Module & module, ModuleLibrary & lib) {
    module.addAnnotation(make_smart<VkExternalFencePropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkExportFenceCreateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkExportSemaphoreCreateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceExternalSemaphoreInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkExternalSemaphorePropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceMaintenance3PropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkDescriptorSetLayoutSupportAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceShaderDrawParametersFeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceVulkan11FeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceVulkan11PropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceVulkan12FeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkConformanceVersionAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceVulkan12PropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkImageFormatListCreateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkAttachmentDescription2Annotation>(lib));
    module.addAnnotation(make_smart<VkAttachmentReference2Annotation>(lib));
    module.addAnnotation(make_smart<VkSubpassDescription2Annotation>(lib));
    module.addAnnotation(make_smart<VkSubpassDependency2Annotation>(lib));
    module.addAnnotation(make_smart<VkRenderPassCreateInfo2Annotation>(lib));
    module.addAnnotation(make_smart<VkSubpassBeginInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkSubpassEndInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDevice8BitStorageFeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceDriverPropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceShaderAtomicInt64FeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceShaderFloat16Int8FeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceFloatControlsPropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkDescriptorSetLayoutBindingFlagsCreateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceDescriptorIndexingFeaturesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceDescriptorIndexingPropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkDescriptorSetVariableDescriptorCountAllocateInfoAnnotation>(lib));
    module.addAnnotation(make_smart<VkDescriptorSetVariableDescriptorCountLayoutSupportAnnotation>(lib));
    module.addAnnotation(make_smart<VkSubpassDescriptionDepthStencilResolveAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceDepthStencilResolvePropertiesAnnotation>(lib));
    module.addAnnotation(make_smart<VkPhysicalDeviceScalarBlockLayoutFeaturesAnnotation>(lib));
}
...
void addVulkanGeneratedConsts_5(Module & module, ModuleLibrary & lib) {
