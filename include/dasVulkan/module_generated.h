...
MAKE_EXTERNAL_TYPE_FACTORY(GLFWmonitor_DasHandle, GLFWmonitor_DasHandle)
typedef GLFWwindow * GLFWwindow_DasHandle;
MAKE_EXTERNAL_TYPE_FACTORY(GLFWwindow_DasHandle, GLFWwindow_DasHandle)
typedef GLFWcursor * GLFWcursor_DasHandle;
MAKE_EXTERNAL_TYPE_FACTORY(GLFWcursor_DasHandle, GLFWcursor_DasHandle)
...
MAKE_EXTERNAL_TYPE_FACTORY(GLFWvidmode, GLFWvidmode);
MAKE_EXTERNAL_TYPE_FACTORY(GLFWgammaramp, GLFWgammaramp);
MAKE_EXTERNAL_TYPE_FACTORY(GLFWimage, GLFWimage);
MAKE_EXTERNAL_TYPE_FACTORY(GLFWgamepadstate, GLFWgamepadstate);
